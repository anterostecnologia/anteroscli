...
interface CompanyCityViewProps extends AnterosViewProps<CompanyCityEntity, typeof CompanyCityEntity.prototype.id> {
}

interface CompanyCityViewState extends AnterosViewState {
}

@boundClass
class CompanyCityView extends AnterosView<CompanyCityEntity, typeof CompanyCityEntity.prototype.id,  CompanyCityViewProps, CompanyCityViewState> {
    onCloseView() {
    ...
    render(): ReactNode {
        ...
        return ( 
          <AnterosTableTemplate 
            ...
            filterName="filterCompanyCity" 
            version="v1" 
            caption={"CompanyCity"} 
            dataSource={dataSource} 
            viewName={"companyCityView"} 
            user={user} 
            pageSize={PAGE_SIZE} 
            currentFilter={currentFilter} 
            needRefresh={needRefresh} 
...
interface CompanyCityFormProps extends AnterosFormComponentProps {
    dataSource: AnterosDatasource;
    saveRoute: string;
    cancelRoute: string;
    needRefresh: boolean;
...
interface CompanyCityFormsState extends AnterosFormComponentState {
}

@boundClass
class CompanyCityForm extends AnterosFormComponent<CompanyCityFormProps, CompanyCityFormsState> {
    constructor(props: CompanyCityFormProps) {
        super(props); 
         this.state = { 
          modalOpen: undefined, 
          lookup: "", 
...
export default connectViewWithStore(resolve<CompanyCityController>(TYPE.companyCity_controller)())(CompanyCityView);
