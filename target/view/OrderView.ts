...
import { AnterosEdit } from "@anterostecnologia/anteros-react-editors";
import { order, homeDefault } from "../route/routes";

interface OrderViewProps extends AnterosViewProps<OrderEntity, typeof OrderEntity.prototype.id> {
}

interface OrderViewState extends AnterosViewState {
}

@boundClass
class OrderView extends AnterosView<OrderEntity, typeof OrderEntity.prototype.id,  OrderViewProps, OrderViewState> {
    onCloseView() {
...
interface OrderTableProps<E extends AnterosEntity, TypeID> {
    user: UserData;
    needRefresh: boolean;
...
@boundClass
class OrderTable extends Component<OrderTableProps<OrderEntity, any>> {
...
interface OrderFormProps extends AnterosFormComponentProps {
    dataSource: AnterosDatasource;
    saveRoute: string;
    cancelRoute: string;
    needRefresh: boolean;
...
interface OrderFormsState extends AnterosFormComponentState {
}

@boundClass
class OrderForm extends AnterosFormComponent<OrderFormProps, OrderFormsState> {
...
export default connectViewWithStore(resolve<OrderController>(TYPE.order_controller)())(OrderView);
