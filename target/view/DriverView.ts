...
interface DriverViewProps extends AnterosViewProps<DriverEntity, typeof DriverEntity.prototype.id> {
}

interface DriverViewState extends AnterosViewState {
}

@boundClass
class DriverView extends AnterosView<DriverEntity, typeof DriverEntity.prototype.id,  DriverViewProps, DriverViewState> {
    onCloseView() {
...
interface DriverFormProps extends AnterosFormComponentProps {
    dataSource: AnterosDatasource;
    saveRoute: string;
    cancelRoute: string;
    needRefresh: boolean;
...
interface DriverFormsState extends AnterosFormComponentState {
}

@boundClass
class DriverForm extends AnterosFormComponent<DriverFormProps, DriverFormsState> {
...
export default connectViewWithStore(resolve<DriverController>(TYPE.driver_controller)())(DriverView);
