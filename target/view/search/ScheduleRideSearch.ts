...
interface ScheduleRideTableProps<E extends AnterosEntity, TypeID> {
    user: UserData;
    needRefresh: boolean;
...
@boundClass
class ScheduleRideTable extends Component<ScheduleRideTableProps<ScheduleRideEntity, any>> {
